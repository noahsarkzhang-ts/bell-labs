...
public class AES256Util {
     ...
     * 密钥, 256位32个字节
     */
    public static final String DEFAULT_SECRET_KEY = "92650041f7b179e5d0bd54fd82e27414";
     ...
     */
    private static final byte[] KEY_VI = "e2a20d9d458ef35d".getBytes();
    ...
    public static void main(String[] args) {
        String dbPassword = "1234567890123456";
