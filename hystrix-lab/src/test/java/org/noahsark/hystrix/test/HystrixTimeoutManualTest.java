...
import org.noahsark.hystrix.RemoteServiceTestCommand;
import org.noahsark.hystrix.RemoteServiceTestSimulator;
import org.noahsark.hystrix.CommandHelloWorld;

import static org.hamcrest.MatcherAssert.assertThat;
import static org.hamcrest.Matchers.equalTo;

/**
 * HystrixTimeoutManualTest
 *
 * @author zhangxt
 * @date 2022/04/24 13:49
 **/
public class HystrixTimeoutManualTest {
    ...
    public void givenSvcTimeoutOf15000AndExecTimeoutOf5000__whenExecuted_thenExpectHRE()
        ...
        config.andCommandPropertiesDefaults(commandProperties);
        assertThat(new RemoteServiceTestCommand(config, new RemoteServiceTestSimulator(15_000)).execute(),
                equalTo("Success"));
    }
